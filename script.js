...
const learnmorebtn8 = document.getElementById("learnmorebtn8");
const learnmorebtn9 = document.getElementById("learnmorebtn9");
const learnmorebtn10 = document.getElementById("learnmorebtn10");
const learnmorebtn8v2 = document.getElementById("learnmorebtn8-v2");
const learnmorebtn9v2 = document.getElementById("learnmorebtn9-v2");
const learnmorebtn10v2 = document.getElementById("learnmorebtn10-v2");
...
function findMatch(descriptor) {
  return recognizedFaces.find(
    (recognizedFace) =>
      faceapi.euclideanDistance(recognizedFace.descriptor, descriptor) < 0.6
  );
}
...
learnmorebtn3.addEventListener("click", function () {
  ...
  page5.style.transform = "translateX(-200%)";
  page6.style.transform = "translateX(-200%)";
});
...
learnmorebtn7.addEventListener("click", function () {
  page1.style.transform = "translateX(-300%)";
  page2.style.transform = "translateX(-300%)";
  page3.style.transform = "translateX(-300%)";
  page4.style.transform = "translateX(-300%)";
  page5.style.transform = "translateX(-300%)";
  page6.style.transform = "translateX(-300%)";
});

learnmorebtn8.addEventListener("click", function () {
  page1.style.transform = "translateX(-100%)";
  page2.style.transform = "translateX(-100%)";
  page3.style.transform = "translateX(-100%)";
  page4.style.transform = "translateX(-100%)";
...
learnmorebtn9.addEventListener("click", function () {
  page1.style.transform = "translateX(-300%)";
  page2.style.transform = "translateX(-300%)";
  page3.style.transform = "translateX(-300%)";
  page4.style.transform = "translateX(-300%)";
...
learnmorebtn10.addEventListener("click", function () {
  page1.style.transform = "translateX(-200%)";
  page2.style.transform = "translateX(-200%)";
  page3.style.transform = "translateX(-200%)";
  page4.style.transform = "translateX(-200%)";
...
learnmorebtn8v2.addEventListener("click", function () {
  page1.style.transform = "translateX(-200%)";
  page2.style.transform = "translateX(-200%)";
  page3.style.transform = "translateX(-200%)";
  page4.style.transform = "translateX(-200%)";
...
learnmorebtn9v2.addEventListener("click", function () {
  page1.style.transform = "translateX(-400%)";
  page2.style.transform = "translateX(-400%)";
  page3.style.transform = "translateX(-400%)";
  page4.style.transform = "translateX(-400%)";
  page5.style.transform = "translateX(-400%)";
  page6.style.transform = "translateX(-400%)";
});

learnmorebtn10v2.addEventListener("click", function () {
  page1.style.transform = "translateX(-300%)";
  page2.style.transform = "translateX(-300%)";
  page3.style.transform = "translateX(-300%)";
  page4.style.transform = "translateX(-300%)";
...
function adjustVideoSize() {
  ...
  if (screenWidth <= 1280) {
    videoElement.width = 630;
  }
  if (screenWidth <= 1024) {
    videoElement.width = 450;
  }
  if (screenWidth <= 600) {
    videoElement.width = 365;
    videoElement.height = 450;
  }
}

// Adjust video size on load
